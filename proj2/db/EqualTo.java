 ...
 */
public class EqualTo extends ComparisonOperators{
    ...
    public EqualTo(String split1, String split2, String operand, Table t, Table curr, String condition) {
        this.split1 = split1;
        this.split2 = split2;
    ...
    public Table evalOp() {
        ...
        if (condition.equals("Unary")) {
            ...
            if (c.getMyType().equals("string")) {
                //means that both column type and split2 are strings.
                for (int i = 0; i < c.getValues().size(); i++) {
                    if (!(c.getValues().get(i).equals(c2.getValues().get(i)))) {
                        removeRowIndices.add(i);
                    }
                }
